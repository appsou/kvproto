...
const (
	...
	MessageType_CmdRawScan   MessageType = 259
)
...
type CmdRawScanResponse struct {
	Pairs            []*KvPair `protobuf:"bytes,1,rep,name=pairs" json:"pairs,omitempty"`
	XXX_unrecognized []byte    `json:"-"`
}

func (m *CmdRawScanResponse) Reset()                    { *m = CmdRawScanResponse{} }
func (m *CmdRawScanResponse) String() string            { return proto.CompactTextString(m) }
func (*CmdRawScanResponse) ProtoMessage()               {}
func (*CmdRawScanResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{19} }

func (m *CmdRawScanResponse) GetPairs() []*KvPair {
	if m != nil {
		return m.Pairs
	}
	return nil
...
func (*CmdScanLockRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{20} }
...
func (*CmdScanLockResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{21} }
...
func (*CmdResolveLockRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{22} }
...
func (*CmdResolveLockResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{23} }
...
func (*CmdGCRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{24} }
...
func (*CmdGCResponse) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{25} }
...
func (*CmdRawGetRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{26} }
...
func (m *CmdRawScanRequest) Reset()                    { *m = CmdRawScanRequest{} }
func (m *CmdRawScanRequest) String() string            { return proto.CompactTextString(m) }
func (*CmdRawScanRequest) ProtoMessage()               {}
func (*CmdRawScanRequest) Descriptor() ([]byte, []int) { return fileDescriptorKvrpcpb, []int{27} }

func (m *CmdRawScanRequest) GetStartKey() []byte {
	if m != nil {
		return m.StartKey
	}
	return nil
...
func (m *CmdRawScanRequest) GetEndKey() []byte {
	if m != nil {
		return m.EndKey
	}
	return nil
...
func (m *CmdRawScanRequest) GetLimit() uint64 {
...
type Request struct {
	...
	CmdRawScanReq       *CmdRawScanRequest       `protobuf:"bytes,259,opt,name=cmd_raw_scan_req,json=cmdRawScanReq" json:"cmd_raw_scan_req,omitempty"`
	XXX_unrecognized    []byte                   `json:"-"`
}
...
func (m *Request) GetCmdRawScanReq() *CmdRawScanRequest {
	if m != nil {
		return m.CmdRawScanReq
	}
	return nil
}
...
type Response struct {
	...
	CmdRawScanResp       *CmdRawScanResponse       `protobuf:"bytes,259,opt,name=cmd_raw_scan_resp,json=cmdRawScanResp" json:"cmd_raw_scan_resp,omitempty"`
	XXX_unrecognized     []byte                    `json:"-"`
}
...
func (m *Response) GetCmdRawScanResp() *CmdRawScanResponse {
	if m != nil {
		return m.CmdRawScanResp
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*CmdRawScanResponse)(nil), "kvrpcpb.CmdRawScanResponse")
	...
	proto.RegisterType((*CmdRawScanRequest)(nil), "kvrpcpb.CmdRawScanRequest")
...
func (m *CmdRawScanResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CmdRawScanResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CmdRawScanRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CmdRawScanRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CmdRawScanReq != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x10
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.CmdRawScanReq.Size()))
		n26, err := m.CmdRawScanReq.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *Response) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CmdRawGetResp != nil {
		...
		n38, err := m.CmdRawGetResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
	...
	if m.CmdRawPutResp != nil {
		...
		n39, err := m.CmdRawPutResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
	...
	if m.CmdRawDeleteResp != nil {
		...
		n40, err := m.CmdRawDeleteResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	}
	if m.CmdRawScanResp != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x10
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.CmdRawScanResp.Size()))
		n41, err := m.CmdRawScanResp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *CmdRawScanResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Pairs) > 0 {
		for _, e := range m.Pairs {
...
func (m *CmdRawScanRequest) Size() (n int) {
	var l int
	_ = l
	if m.StartKey != nil {
		l = len(m.StartKey)
...
func (m *CmdRawScanResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CmdRawScanResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CmdRawScanResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CmdRawScanRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CmdRawScanRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CmdRawScanRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 259:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CmdRawScanReq", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CmdRawScanReq == nil {
				m.CmdRawScanReq = &CmdRawScanRequest{}
			}
			if err := m.CmdRawScanReq.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 259:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CmdRawScanResp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CmdRawScanResp == nil {
				m.CmdRawScanResp = &CmdRawScanResponse{}
			}
			if err := m.CmdRawScanResp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
